    ...
    <div className="flex min-h-screen flex-col">
        ...
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-8 px-3 pb-10 pt-14 xs:px-4 md:grid-cols-2 md:px-6 md:pb-20 md:pt-24 2xl:gap-12">
          <div className="animate-fade-in">
            ...
            <p className="mt-4 text-base text-muted-foreground xs:text-lg lg:text-xl">
              TripGenius uses AI to create personalized itineraries with
              real-time weather, flight & hotel search, budget tracking, and
              group collaboration — all in one place.
            </p>
            ...
            <div className="mt-6 flex items-center gap-6 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                <Calendar className="h-4 w-4" /> Drag & Drop
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 gap-6 rounded-3xl border p-6 xs:gap-8 xs:p-8 md:grid-cols-2 animate-slide-in-up transition-smooth hover-glow">
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                APIs: OpenAI, Skyscanner, Booking.com, Google Maps, OpenWeather,
                Currency, Yelp/Eventbrite
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li>
                Phase 1 — MVP: AI itinerary, weather & maps, flight/hotel
                search, trip dashboard
              </li>
              <li>
                Phase 2 — Expansion: AI chat, calendar drag-drop, budget &
                currency, collaboration, local events
              </li>
              <li>
                Phase 3 — Monetization: PDF export, visa checker, templates
                marketplace, subscriptions & alerts
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="mx-auto mb-16 w-full max-w-7xl px-3 xs:px-4 md:px-6">
        <div className="rounded-3xl bg-gradient-to-r from-primary to-accent px-6 py-8 text-primary-foreground xs:px-8 xs:py-10 animate-slide-in-up transition-smooth hover:shadow-2xl">
          ...
          <p className="mt-2 max-w-2xl text-sm opacity-90 xs:text-base">
            Generate a complete itinerary in seconds. Invite your friends. Track
            your budget. All in TripGenius.
          </p>
          <div className="mt-5">
            <Button asChild size="lg" variant="secondary">
              <Link to="/planner" className="font-semibold">
                Launch Planner
              </Link>
            </Button>
          </div>
