        ...
        {!itinerary && !loading && !calendar?.length ? (
          <div className="py-16 text-center text-muted-foreground animate-in fade-in duration-700">
            ...
            <p className="max-w-md mx-auto text-sm">
              Fill out your trip details above and let our AI craft the perfect
              customized journey for you.
            </p>
          </div>
        ) : (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
            <div className="sticky top-16 z-10 bg-background/95 backdrop-blur py-2 border-b shadow-sm -mx-3 px-3 sm:mx-0 sm:px-0 sm:shadow-none sm:border-none sm:py-0 sm:static sm:bg-transparent">
              <Tabs
                value={activeTab}
                ...
                <div className="animate-in fade-in duration-300">
                  <Card>
                    <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
                      <div>
                        <CardTitle className="flex items-center gap-2 text-base">
                          <CloudSun className="h-5 w-5 text-primary" /> Weather
                          Preview ☀️
                        </CardTitle>
                        <p className="text-sm text-muted-foreground mt-2">
                    ...
                    <CardContent className={openTransport ? "" : "hidden"}>
                      {travel?.options?.length ? (
                        <div className="mb-2 flex flex-wrap items-center gap-1 text-xs">
                          ...
                          {(["all", "cheapest", "fastest", "eco"] as const).map(
                            (f) => (
                              <button
                                key={f}
                      ...
                      >
                        ...
                        {(
                          ["flight", "train", "bus", "car", "waterway"] as const
                        ).map((t) => (
                            ...
                            >
                              <div className="mb-1 flex items-center justify-between gap-1">
                                ...
                                <div className="text-xs text-muted-foreground truncate">
                                  {
                                    itinerary?.days.find((x) => x.day === d.day)
                                      ?.theme
                                  }
                                </div>
                              </div>
